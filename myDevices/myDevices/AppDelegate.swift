...
//  myDevices
//
//  Created by Brian J Glowe on 11/16/15.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func addTestData() {
        guard let entity =
            NSEntityDescription.entityForName("Device", inManagedObjectContext: managedObjectContext) else {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "BG.myDevices" in the application's documents Application Support directory.
